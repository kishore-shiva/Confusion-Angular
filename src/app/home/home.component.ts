...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.promotionService.getFeaturedPromotion().subscribe((promotion) => (this.promotion) = promotion, promoerr => this.promotionErrMess = <any>promoerr);
    this.leaderService.getFeaturedLeader().subscribe((leader) => (this.leader) = leader, leadererr => this.leaderErrMess = <any> leadererr);
  }
